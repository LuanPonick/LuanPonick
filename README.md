...
Você pode ver meus repositórios de estudos/tutoriais de html, css, js, java e mais algumas outras linguagens web. Tambem há alguns projetos de programação de jogos 2D na unity ou de alguma coisa web que eu quis inventar 😁:
...
## Meus projetos relacionados a front-end
   > [Future clothes](https://github.com/LuanPonick/WebProject/blob/main/Meus%20projetos/FutureClothes/tentativa06/)
   > ➡️[Acesse o site clicando em mim](https://luanponick.github.io/WebProject/Meus%20projetos/FutureClothes/tentativa06/pages/index.html)⬅️
   > Esse é um site simples que fiz utilizando HTML e CSS. Meu principal objetivo foi focar em estudar sobre responsividade, e eu consegui. Esse site está completo, ou seja, ele funciona em telas maiores como monitores e também para dispositivos menores como smartphones. Também há algumas animações simples, mas não era o objetivo principal. Toda a parte de designe e programação foi feita por mim, para a criação do designe eu utilizei o Figma. A página do projeto no Figma pode ser acessada [aqui](https://www.figma.com/community/file/1214570901829823007) ou, se quiser, no final da página eu falo sobre meus outros projetos de designe que fiz no Figma.
 ...
 >~~~
 >Começar no 1 termina no 3 com passos de 1 : 
 >1, 2, 3
 > 
 >Começar no -3 termina no 3 com passos de 2 : 
 >-3, -1, 1, 3
 > 
 >Começa no -3 temina no -9 com passos de -3 :
 >-3 -6 -9  
 >~~~
 ...
 >Esse projeto é do curso do Gustavo Guanabara (Curso em Vídeo), porém, no vídeo dele, ele faz uma lógica bem simples que só era possível utilizar passos positivos, porém eu quis ilustrar essa lógica apenas por diversão e para aprender um pouco mais e fixar principalmente os conceitos passados na aula.

 ## Meus Estudos Angular/po-ui
   > ### [Angular_PO-UI/](https://github.com/LuanPonick/Angular_PO-UI)
   > Repositorio relacionado a estudos sobre Angular e ou PO-UI
   > >  ### [Angular PO-UI/Angular](https://github.com/LuanPonick/Angular_PO-UI/tree/main/Angular) ⭐
   > > Aqui tem meu estudo sobre o framework Angular, eu fiz em uma forma que caso eu tenha alguma dúvida referente ao framework angular eu possa revisitar esse repositório para ler o documento(MD) e tirar minhas dúvidas, eu gostei bastante do resultado, não está 100% pronto, mas já tem bastante coisa [aqui](https://github.com/LuanPonick/Angular_PO-UI/tree/main/Angular). Enquanto eu estava estudando sobre esse tema, eu estava criando um site utilizando o framework angular para ir treinando o que eu estava aprendendo. Caso queira visitá-lo, clique [aqui](https://github.com/LuanPonick/Angular_PO-UI/tree/main/Angular). Vale ressaltar que, como é só um site demo, não fiz questão de deixá-lo tão bonito.

 ## Meus projeto Angular e ou po-ui
   > ### [Calendariozinho](https://github.com/LuanPonick/Calendariozinho)
   > Um projeto que tem a ideia de ser, como o nome sugere, um calendário. Nesse projeto, eu estou usando angular e po-ui. Nele, eu tentei ao máximo customizar o po-ui para que se adapte ao que eu queria, acabei constatando que não valeria a pena continuar porque eu alterei tanta coisa para chegar no objetivo desejado que achei melhor deixá-lo de lado. Mas eu achei legal como uma forma de estudo, com esse projeto eu consegui me habituar um pouco mais com o po-ui e descobrir novas formas de fazer gambiarras se necessário para apagar o fogo kk. Também há um designe referente a esse projeto que, caso queira, pode ser visto aqui. OU, caso queira ver, ele estará anexado ao fim da página na minha parte referente aos meus designes.
